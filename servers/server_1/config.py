...
class ServerConfig(BaseSettings):
    ...
    HOST: str = os.getenv("SERVER_1_HOST", "127.0.0.1")
    PORT: int = int(os.getenv("SERVER_1_PORT", 8001))
    SUPPORTED_CITIES: List[str] = [
        "New York",
        "Los Angeles",
        "Chicago",
    ...
    WEATHER_API_KEY: str = os.getenv("WEATHER_API_KEY", "dummy_key")  # Optional
